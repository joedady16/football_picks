...
WHERE w.season_year = 2026 AND w.week_number = 99;
...
) WHERE season_year = 2026 AND week_number = 99;
...
WHERE e.is_me AND w.season_year = 2026 AND w.week_number = 99;
...
FROM v_pick_result
WHERE is_me AND season_year = 2026 AND week_number = 99
ORDER BY note;
...
FROM v_field_gap WHERE season_year = 2026 ORDER BY home_team;

\echo ''
\echo '=== 4. contrarian buckets, league and public scopes ==='
SELECT scope, field_bucket, graded, wins, win_pct
FROM v_my_contrarian WHERE season_year = 2026 ORDER BY scope, field_bucket;
...
FROM v_entrant_week WHERE season_year = 2026 AND week_number = 99;
...
FROM v_tiebreak WHERE season_year = 2026 AND week_number = 99;
...
WHERE e.display_name = 'TestRival2' AND w.week_number = 99
...
FROM week WHERE season_year = 2026 AND week_number = 99;
INSERT INTO pick (entrant_id, game_id, picked_team_id)
